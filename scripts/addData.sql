...
insert into Users(Balance,Email,FirstName,LastName,Login,Password,CustomerTypeRef,RegionRef,RoleRef,IsUserActive) values(10,'mail@gmail.com','nonemyroslav','noneshram','nonemyroslav','qwerty',2,3,$
...
insert into Users(Balance,Email,FirstName,LastName,Login,Password,CustomerTypeRef,RegionRef,RoleRef,IsUserActive) values(10,'mail@gmail.com','nonevitalik','nonenobis','nonevitalik','qwerty',4,1,1,$
...
insert into Users(Balance,Email,FirstName,LastName,Login,Password,CustomerTypeRef,RegionRef,RoleRef,IsUserActive) values(10,'mail@gmail.com','noneroman','nonenazarevuch','noneromanN','qwerty',2,3,$
...
insert into Users(Balance,Email,FirstName,LastName,Login,Password,CustomerTypeRef,RegionRef,RoleRef,IsUserActive) values(10,'mail@gmail.com','nonefirstName1','nonelastName1','nonelogin1','qwerty',$
insert into Users(Balance,Email,FirstName,LastName,Login,Password,CustomerTypeRef,RegionRef,RoleRef,IsUserActive) values(10,'mail@gmail.com','nonefirstName2','nonelastName2','nonelogin2','qwerty',$
insert into Users(Balance,Email,FirstName,LastName,Login,Password,CustomerTypeRef,RegionRef,RoleRef,IsUserActive) values(10,'mail@gmail.com','nonefirstName3','nonelastName3','nonelogin3','qwerty',$
insert into Users(Balance,Email,FirstName,LastName,Login,Password,CustomerTypeRef,RegionRef,RoleRef,IsUserActive) values(10,'mail@gmail.com','nonefirstName4','nonelastName4','nonelogin4','qwerty',$

insert into Orders(DeliveryDate,OrderDate,PreferableDeliveryDate,TotalPrice,Assigne,Customer,OrderStatusRef,MaxDiscount,OrderName,OrderNumber,IsGift) values('2012-12-02 00:00:00.000','2010-12-02 0$
insert into Orders(DeliveryDate,OrderDate,PreferableDeliveryDate,TotalPrice,Assigne,Customer,OrderStatusRef,MaxDiscount,OrderName,OrderNumber,IsGift) values('2012-12-02 00:00:00.000','2010-12-02 0$
insert into Orders(DeliveryDate,OrderDate,PreferableDeliveryDate,TotalPrice,Assigne,Customer,OrderStatusRef,MaxDiscount,OrderName,OrderNumber,IsGift) values('2012-12-02 00:00:00.000','2010-12-02 0$
insert into Orders(DeliveryDate,OrderDate,PreferableDeliveryDate,TotalPrice,Assigne,Customer,OrderStatusRef,MaxDiscount,OrderName,OrderNumber,IsGift) values('2012-12-02 00:00:00.000','2010-12-02 0$
insert into Orders(DeliveryDate,OrderDate,PreferableDeliveryDate,TotalPrice,Assigne,Customer,OrderStatusRef,MaxDiscount,OrderName,OrderNumber,IsGift) values('2012-12-02 00:00:00.000','2010-12-02 0$
